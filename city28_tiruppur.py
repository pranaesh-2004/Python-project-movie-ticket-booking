...
def theatre1():
  messagebox.askyesno("Information","Select Tiruppur theatres.?")
  root.destroy()
  Tiruppur_theatres()
...
def Usha_films():
 ...
 messagebox.showinfo("Information","Selectd Usha theatres")
 root.destroy()
 Usha_films1()
...
def Chola_films():
 ...
 messagebox.showinfo("Information","Selectd Chola theatres")
 root.destroy()
 Chola_films1()
...
def Tiruppur_theatres():
 ...
 frame = Frame(root,width=3200,height=3500,bg='gray')
 frame.place(x=0,y=0)
 at1 = Label(frame,width = 100, fg="black",bg = "sky blue", border = 4,text="Theatres available in Tiruppur..!",font = ("Times new roman",11,"bold"))
 at1.place(x = 40,y = 12)
 ...
 theatres = []
 t1=Button(frame,height=0,width = 65,pady=2,text='Usha theatre',bg='red',command=Usha_films,font=('Times New Roman',10,'bold'),fg='white',border=0).place(x=100,y=75)
 theatres.append(t1)
 t2=Button(frame,height=0,width = 65,pady=2,text='Devi',bg='red',command = surya_films,font=('Times New Roman',10,'bold'),fg='white',border=0).place(x=100,y=115)
 theatres.append(t2)
 t3=Button(frame,height=0,width = 65,pady=2,text='Chola theatre',bg='red',command = Chola_films,font=('Times New Roman',10,'bold'),fg='white',border=0).place(x=100,y=155)
 theatres.append(t3)
...
s = Label(frame,width = 65, fg="black",bg = "white", border = 4,text=">>>>> Select theatres in Tiruppur..! <<<<<",font = ("Times new roman",11,"bold"))
s.place(x = 40,y = 12)
