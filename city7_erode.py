...
def theatre1():
  messagebox.askyesno("Information","Select Erode theatres.?")
  root.destroy()
  Erode_theatres()
...
def Erode_theatres():
 ...
 frame = Frame(root,width=3200,height=3500,bg='gray')
 frame.place(x=0,y=0)
 at1 = Label(frame,width = 100, fg="black",bg = "sky blue", border = 4,text="Theatres available in Erode..!",font = ("Times sangeetha roman",11,"bold"))
 at1.place(x = 40,y = 12)
...
s = Label(frame,width = 65, fg="black",bg = "white", border = 4,text=">>>>> Select theatres in Erode..! <<<<<",font = ("Times sangeetha roman",11,"bold"))
s.place(x = 40,y = 12)
