...
def theatre1():
  messagebox.askyesno("Information","Select Pudukottai theatres.?")
  root.destroy()
  Pudukottai_theatres()
...
def vest_films():
 ...
 messagebox.showinfo("Information","Selectd vest theatres")
 root.destroy()
 vest_films1()
...
def D_films():
 ...
 messagebox.showinfo("Information","Selectd D theatres")
 root.destroy()
 D_films1()
...
def Rajasekaran_films():
 root = Tk()
 root.geometry('925x500+700+200')
 root.title("Rajasekaran")

 frame = Frame(root,width=3200,height=3500,bg='gray')
 frame.place(x=0,y=0)

 messagebox.showinfo("Information","Selectd Rajasekaran theatres")
 root.destroy()
 Rajasekaran_films1()


def Rajasekaran_films1():
 win = Tk()
 win.geometry('925x500+700+200')
 win.title("Rajasekaran")
...
def Pudukottai_theatres():
 ...
 frame = Frame(root,width=3200,height=3500,bg='gray')
 frame.place(x=0,y=0)
 at1 = Label(frame,width = 100, fg="black",bg = "sky blue", border = 4,text="Theatres available in Pudukottai..!",font = ("Times new roman",11,"bold"))
 at1.place(x = 40,y = 12)
 ...
 theatres = []
 t1=Button(frame,height=0,width = 65,pady=2,text='vest theatre',bg='red',command=vest_films,font=('Times New Roman',10,'bold'),fg='white',border=0).place(x=100,y=75)
 theatres.append(t1)
 t2=Button(frame,height=0,width = 65,pady=2,text='D max',bg='red',command = D_films,font=('Times New Roman',10,'bold'),fg='white',border=0).place(x=100,y=115)
 theatres.append(t2)
 t3=Button(frame,height=0,width = 65,pady=2,text='Rajasekaran theatre',bg='red',command = Rajasekaran_films,font=('Times New Roman',10,'bold'),fg='white',border=0).place(x=100,y=155)
 theatres.append(t3)
...
s = Label(frame,width = 65, fg="black",bg = "white", border = 4,text=">>>>> Select theatres in Pudukottai..! <<<<<",font = ("Times new roman",11,"bold"))
s.place(x = 40,y = 12)
