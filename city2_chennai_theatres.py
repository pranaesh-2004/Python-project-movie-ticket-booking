...
def book_seats_th1_a():
    ...
    def confirm_booking_th1_a():
        ...
        if len(selected_seats) > 0:
            ...
            theater = "Albert theatre"  # Replace with the actual theater name
...
def book_seats_th2_a():
    ...
    def confirm_booking_th2_a():
        ...
        if len(selected_seats) > 0:
            num_seats = len(selected_seats)
            movie_name = "Thandatti-2"  # Replace with the actual movie name
            show_time = f"{selected_time}"  # Replace with the actual show time
            theater = "Gk theatre"  # Replace with the actual theater name
...
def book_seats_th3_a():
    ...
    def confirm_booking_th3_a():
        ...
        if len(selected_seats) > 0:
            ...
            show_time = f"{selected_time}"  # Replace with the actual show time
            theater = "Raj theatre"  # Replace with the actual theater name
...
def Albert_films():
    messagebox.showinfo("Information", "Selected Albert theatres")
    root.destroy()
    Albert_films1()
...
def Albert_films1():
    ...
    s_films.append(sm1)
    sm2 = Button(frame,height = 0,width= 65,pady=2,fg="black",bg = "sky blue", border = 0,text="Regina",command = get_seats_th1_b,font = ("Times new roman",11,"bold")).place(x = 50,y = 90)
    s_films.append(sm2)

def Gk_films():
    messagebox.showinfo("Information", "Selected Gk theatres")
    root.destroy()
    Gk_films1()
...
def Gk_films1():
    ...
    st_films=[]
    st1 = Button(frame,height = 0,width= 65,pady=2,fg="black",bg = "sky blue", border = 0,text="Thandatti-2",command = get_seats_th2_a,font = ("Times new roman",11,"bold")).place(x = 50,y = 50)
    st_films.append(st1)
...
def Raj_films():
    messagebox.showinfo("Information", "Selected Raj theatres")
    root.destroy()
    Raj_films1()
...
def Raj_films1():
    ...
    jt_films=[]
    jt1 = Button(frame,height = 0,width= 65,pady=2,fg="black",bg = "sky blue", border = 0,text="Adipurush",command = get_seats_th3_a,font = ("Times new roman",11,"bold")).place(x = 50,y = 50)
    jt_films.append(jt1)
...
def Chennai_theatres():


    at1 = Label(frame, width=68, fg="black", bg="sky blue", border=4, text="<<<< Theatres available in Chennai..! >>>>",
    ...
    theatres = []
    t1=Button(frame,height=0,width = 65,pady=2,text='Albert theatre',bg='red',command=Albert_films,font=('Times New Roman',10,'bold'),fg='white',border=0).place(x=100,y=75)
    theatres.append(t1)
    t2=Button(frame,height=0,width = 65,pady=2,text='Gk max',bg='red',command = Gk_films,font=('Times New Roman',10,'bold'),fg='white',border=0).place(x=100,y=115)
    theatres.append(t2)
    t3=Button(frame,height=0,width = 65,pady=2,text='Raj theatre',bg='red',command = Raj_films,font=('Times New Roman',10,'bold'),fg='white',border=0).place(x=100,y=155)
    theatres.append(t3)
